...
import type { RegisterUserInput, LoginUserInput, GetUserByIdInput, PublicUser } from "../schemas/user.schema";
...
const formatUserResponse = (user: UserEntity): PublicUser => {
...
export const getUserById = async (req: Request, res: Response, next: NextFunction) => {
	try {
		...
		const { id: userId } = req.params as GetUserByIdInput;
