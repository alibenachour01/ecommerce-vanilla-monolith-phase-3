...
app.listen(PORT, () => {
	...
	console.log("\nTest commands:");
	console.log(
		'curl -X POST http://localhost:3001/test-register -H "Content-Type: application/json" -d \'{"email": "test@example.com", "password": "StrongPassword123"}\'',
	);
	console.log(
		'curl -X POST http://localhost:3001/test-register -H "Content-Type: application/json" -d \'{"email": "invalid-email", "password": "weak"}\'',
	);
