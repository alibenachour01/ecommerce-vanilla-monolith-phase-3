...
try {
	...
	console.log("✅ Invalid registration data correctly failed:", (error as Error).message);
}
...
try {
	...
	console.log("✅ Invalid email correctly failed:", (error as Error).message);
}
...
try {
	...
	console.log("✅ Invalid user ID correctly failed:", (error as Error).message);
}
